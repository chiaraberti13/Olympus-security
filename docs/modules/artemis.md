...
query strings, preventing accidental tokens from entering logs. This task performs zero network
requests; the demo uses only the synthetic Olympus Demo Corp domain.
